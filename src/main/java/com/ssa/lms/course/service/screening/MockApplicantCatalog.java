...
public class MockApplicantCatalog {
    ...
    private static final List<MockApplicant> APPLICANTS = List.of(
            // ── 아주 적합 (98점) ──
            new MockApplicant("김서연", "seoyeon_k", DATA_CODE, DATA_NAME, 1,
            ...
            // ── 아주 적합 (92점) ──
            new MockApplicant("박지훈", "jihoon_p", CLOUD_CODE, CLOUD_NAME, 1,
            ...
            // ── 적합 (84점) ──
            new MockApplicant("정민수", "minsu_j", CLOUD_CODE, CLOUD_NAME, 3,
